    ...
    'bjyauthorize' => [
        ...
        'guards' => [
            \BjyAuthorize\Guard\Route::class => [
                ...
                ['route' => 'rss', 'roles' => ['guest', 'user', 'admin']],
                ['route' => 'xml', 'roles' => ['guest', 'user', 'admin']],
                ['route' => 'json', 'roles' => ['guest', 'user', 'admin']],
                ['route' => 'ajax', 'roles' => ['guest', 'user', 'admin']],
                ['route' => 'pdf', 'roles' => ['guest', 'user', 'admin']],
